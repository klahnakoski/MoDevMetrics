							...
							"query": {
                           	...
                           	"filter" : {
                                "and":[
									...
									{"or":[
										{"terms" : {"status_whiteboard.tokenized" : [ "regression-window-wanted", "regressionwindow-wanted"]}},
...
//					"track" : true,
					"evaluations" : {
						'Total (Normalized)' : ['Total', "-", "135"]
					 },
					"showSeries" : ["Open", "Total (Normalized)"],
					"chartTitle" : " RegressionWindow Wanted Bugs (Core, Firefox, Toolkit)",
					"canvas" : "chart",
					"originZero" : false,
					"chartType" : "LineChart",
					"groupSize" : 1,
