	...
	<BODY>
		...
		var createChart = function()
		{
			...
			var chartRequest = { 
						...
						"query" : {
							"query" : {
								"bool" : {
									"must" : [
								        { "term": { "major_status": "CLOSED" } },
								        { "term": { "flags" : "blocking-fennec1.0-soft"} }
						            ]
								}
							},
							"from" : 0,
					...
					"evaluations" : { 
						'blocking-fennec1.0-beta+' : ['close beta+','-','close beta+ prev'],
						'blocking-fennec1.0+' : ['close +','-','close + prev'],
						'blocking-fennec1.0-soft' : ['close soft','-','close soft prev'],
						'blocking-fennec1.0-' : ['close -','-','close - prev'],
				 	},
					"showSeries" : [ 'blocking-fennec1.0+', 'blocking-fennec1.0-beta+', 'blocking-fennec1.0-soft', 'blocking-fennec1.0-' ],
					"chartTitle" : "Fennec Native - Close Rate By Flag",
					"canvas" : "chart",
					"originZero" : true,
