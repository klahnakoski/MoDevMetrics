					...
					"requests" :[
					{
						"query" : {
							"query": {
                           	...
                           	"filter" : {
                                "and":[
                                    { "terms" : { "status_whiteboard.tokenized" : ["memshrink:p1", "memshrink:p2", "memshrink:p3"]} },
                                    {"not" : {
						...
						"seriesName" : "Open MemShrink Bugs"
					},					
					{
                        "query" : {
							"query": {
						...
						"seriesName" : "Total MemShrink Bugs"
					}],
//					"baseline" : [{
//						"name" : "relative scope",
//						"data" : "close",
