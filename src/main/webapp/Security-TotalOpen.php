			...
			var chartRequest = { 
					"requests" :[
					{
						"query" : {
							...
							"filter" : {
								"or" : [
									{ "prefix": { "status_whiteboard_items": "sg:crit" } }
								]
							},
							"from" : 0,
							"size" : 0,
					...
					},
					{
						"query" : {
							...
							"filter" : {
								"or" : [
										{ "prefix": { "status_whiteboard_items": "sg:mod" } }
								]
							},
							"from" : 0,
							"size" : 0,
					...
					},
					{
						"query" : {
							...
							"filter" : {
								"or" : [
										{ "prefix": { "status_whiteboard_items": "sg:low" } }
								]
							},
							"from" : 0,
							"size" : 0,
					...
					},
					{
						"query" : {
							...
							"filter" : {
								"or" : [
										{ "prefix": { "status_whiteboard_items": "sg:dos" } }
								]
							},
							"from" : 0,
							"size" : 0,
						...
						"seriesName" : "open sg:dos",
					}					
					],
					"chartTitle" : "Security - Open Bugs by Priority",
					"canvas" : "chart",
					"originZero" : true,
